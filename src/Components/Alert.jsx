...
export default function Alert({ handleAlertButton }) {
  return (
    <>
      (
      <div className="fixed inset-0 w-screen h-screen backdrop-blur-sm bg-black/45 flex items-center justify-center z-50 p-8">
        <div className="bg-black border border-sky-100 text-sky-100 px-4 py-3 sm:px-6 sm:py-4 rounded-lg max-w-3xl  mx-auto ">
